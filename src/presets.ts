...
export const PRESETS: Preset[] = [
    ...
    // ── Brick pattern presets ─────────────────────────────────────────────
    {
        ...
        brickSettings: {
            ...
            showCracks: false,
            optimizeSVG: false,
            brickTextureMode: 'solid' as const,
            texturePresetName: 'Neon Grid',
    ...
    },
    {
        ...
        brickSettings: {
            ...
            optimizeSVG: false,
            brickTextureMode: 'solid' as const,
            texturePresetName: 'Forest Dream',
            textureRandomizePerBrick: false,
            textureScale: 1,
            textureRotation: 0,
        },
    ...
    {
        name: 'Preset Texture Brick Demo',
        generator: 'brick' as const,
        colors: ['#5a1f11', '#ccb79d'],
        seed: 27831,
        cellSize: 16,
        direction: 'top-bottom',
        randomness: 0,
        brickSettings: {
            ...
            mortarThickness: 4,
            mossDensity: 0,
            brickBaseColor: '#5a1f11',
            mortarColor: '#ccb79d',
            brickVariation: 0.2,
            showCracks: true,
            optimizeSVG: false,
            brickTextureMode: 'singlePreset' as const,
            texturePresetName: 'Geometric Flow',
            textureRandomizePerBrick: true,
            textureScale: 0.8,
            textureRotation: 20,
        },
    },
